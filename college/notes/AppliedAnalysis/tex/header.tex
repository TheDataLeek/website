...
\usepackage{_lib/minted}                                                 % Code display
...
\usepackage{_lib/multicol}                                             % Dynamic Mutlicolumns
...
\newcommand{\bren}[1]{{\left[ #1 \right]}}                                %  Big parens
\newcommand{\cren}[1]{{\left\{ #1 \right\}}}                                %  Big parens
\newcommand{\ms}[1]{\begin{align*} #1 \end{align*}}
\newcommand{\mn}[1]{\begin{align} #1 \end{align}}
\newcommand{\Var}[0]{\text{Var}}                                %  Variance
\newcommand{\Cov}[0]{\text{Cov}}                                %  Variance
\newcommand{\Corr}[0]{\text{Corr}}                                %  Variance
\newcommand{\cl}[0]{{\begin{center}\noindent\rule{4cm}{0.4pt}\end{center}}}
\let\oldvec\vec
