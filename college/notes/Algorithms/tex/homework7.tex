...
\begin{easylist}[enumerate]
    ...
    \lstinputlisting[language=Python, firstline=45, lastline=89]{./code/graph_diameter.py}
    ...
    \lstinputlisting[language=Python, firstline=13, lastline=42]{./code/graph_diameter.py}

    We now use {\ttfamily R}'s {\ttfamily ggplot2} to graph the relationships.

    \lstinputlisting[language=R]{./code/diametergraphs.R}
