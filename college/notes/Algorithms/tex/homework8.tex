...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in library("{}qgraph"{}): there is no package called 'qgraph'}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in qgraph(edges, esize = 5, gray = TRUE): could not find function "{}qgraph"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in qgraph(edges, esize = 5, node.height = 2, node.width = 2, labels = nodes, : could not find function "{}qgraph"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in qgraph(edges1, esize = 5, node.height = 2, node.width = 2, labels = nodes, : could not find function "{}qgraph"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in qgraph(edges2, esize = 5, node.height = 2, node.width = 2, labels = nodes, : could not find function "{}qgraph"{}}}\end{kframe}
\end{knitrout}
